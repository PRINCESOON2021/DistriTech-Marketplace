...
<head>
    ...
    <link rel="stylesheet" href="<?= e(url('assets/css/app.css?v=20260813-19')) ?>">
    <link rel="stylesheet" href="<?= e(url('assets/css/premium.css?v=20260813-19')) ?>">
</head>
<body>
<div class="topbar">Solutions professionnelles pour entreprises au Maroc <a href="<?= e(url('quote.php')) ?>">Demander un audit</a></div>
<header class="site-header">
    <a class="brand brand-logo" href="<?= e(url('index.php')) ?>" aria-label="DISTRITECH — Accueil"><img src="<?= e(url('assets/images/distritech-logo.webp')) ?>" alt="DISTRITECH"></a>
