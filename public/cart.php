...
?>
<section class="section cart-page"><div class="section-heading"><div><span class="eyebrow">VOTRE SÉLECTION</span><h1>Panier</h1></div><a href="<?= e(url('index.php#catalogue')) ?>">Continuer mes achats →</a></div>
<?php if (isset($_GET['added'])): ?><div class="notice success">Produit ajouté au panier.</div><?php endif; ?>
<?php if ($items === []): ?><div class="empty-state"><h2>Votre panier est vide</h2><p>Découvrez les solutions les plus demandées par nos clients professionnels.</p><a class="button primary" href="<?= e(url('index.php#catalogue')) ?>">Voir le catalogue</a></div>
