...
<header class="site-header">
    <a class="brand brand-logo" href="<?= e(url('index.php')) ?>" aria-label="distritech — Accueil"><img src="<?= e(url('assets/images/distritech-logo-minuscule-3d.webp')) ?>" alt="distritech"></a>
