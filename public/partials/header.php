...
<head>
    ...
    <link rel="stylesheet" href="<?= e(url('assets/css/app.css?v=20260813-2')) ?>">
    <link rel="stylesheet" href="<?= e(url('assets/css/premium.css?v=20260813-2')) ?>">
</head>
<body>
<div class="topbar">Solutions professionnelles pour entreprises au Maroc <a href="<?= e(url('quote.php')) ?>">Demander un audit</a></div>
<header class="site-header">
    <a class="brand" href="<?= e(url('index.php')) ?>"><span>DISTRI</span>TECH<small>IT • CYBER • CLOUD</small></a>
...
<main>
<?php require __DIR__ . '/product-slider.php'; ?>
