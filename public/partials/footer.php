...
<footer class="site-footer">
    <div><a class="brand brand-logo brand-logo-footer" href="<?= e(url('index.php')) ?>" aria-label="DISTRITECH — Accueil"><img src="<?= e(url('assets/images/distritech-logo-rouge.webp')) ?>" alt="DISTRITECH"></a><p>Votre partenaire IT, cybersécurité et cloud.</p></div>
...
<script src="<?= e(url('assets/js/app.js?v=20260813-9')) ?>"></script>
</body>
</html>
