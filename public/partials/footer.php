...
<footer class="site-footer">
    ...
    <div><b>Contact</b><a href="<?= e(url('quote.php')) ?>">Demander un devis</a><a href="<?= e(url('privacy.php')) ?>">Notre politique de confidentialité</a><span>Maroc</span></div>
    <div class="footer-copyright">© 2021 Distritech – Distribution &amp; Technologies. All rights reserved.</div>
</footer>
<script src="<?= e(url('assets/js/app.js?v=20260813-10')) ?>"></script>
</body>
</html>
